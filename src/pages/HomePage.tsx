...
const HomePage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Accueil - SportRadar</title>
        <meta name="description" content="Bienvenue sur SportRadar, votre coach intelligent pour un bien-être sportif personnalisé." />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Accueil - SportRadar" />
        <meta property="og:description" content="Votre coach intelligent pour un bien-être sportif personnalisé." />
        <meta property="og:image" content="https://ias-b3-1-lyon-g1-jjrh.onrender.com/images/hero/logo_sportRadar.png" />
        <meta property="og:url" content="https://ias-b3-1-lyon-g1-jjrh.onrender.com/" />
