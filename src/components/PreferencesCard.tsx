...
import { MapPin, Zap, ActivitySquare, Target } from 'lucide-react';
  ...
  <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 mb-8">
    <div className="flex items-center bg-gray-100 p-4 rounded-lg">
      ...
      <div>
        ...
        <p className="font-semibold text-gray-800">{preferences.location || 'Non spécifiée'}</p>
      </div>
    </div>
    <div className="flex items-center bg-gray-100 p-4 rounded-lg">
      ...
      <div>
        ...
        <p className="font-semibold text-gray-800">{preferences.level || 'Non spécifié'}</p>
      </div>
    </div>
    <div className="flex items-center bg-gray-100 p-4 rounded-lg">
    ...
    <div className="flex items-center bg-gray-100 p-4 rounded-lg">
      ...
      <div>
        ...
        <p className="font-semibold text-gray-800">
          {preferences.objectives && preferences.objectives.length
